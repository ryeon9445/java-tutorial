...
public class ReduceTest {
    ...
    @Test
    public void testSum() {
        int  totalOfCharactersInAllFriends= Data.FRIENDS.stream()
    ...
    public void testReduce() {
        final Optional<String> aLongName = Data.FRIENDS.stream()
    ...
    public void testReduce2() {
        final String steveOrLonger = Data.FRIENDS.stream()
